...
* Updated **CHANGELOG.md** to document the changelog finishing touch recipe execution:
  ...
  * Added timestamped changelog entry (`29/06/2026 – 00:20`) following Keep a Changelog format
...
* Updated **CHANGELOG.md** to document the changelog finishing touch recipe execution:
  ...
  * Added timestamped changelog entry (`29/06/2026 – 00:19`) following Keep a Changelog format
  * Entry covers the update to CHANGELOG.md that documented the previous changelog automation chore
...
* Updated **CHANGELOG.md** to document the changelog finishing touch recipe execution:
  ...
  * Added timestamped changelog entry (`29/06/2026 – 00:18`) following Keep a Changelog format
  * Entry covers the update to CHANGELOG.md that documented the previous changelog automation chore
...
* Updated **CHANGELOG.md** to document the changelog finishing touch recipe execution:
  ...
  * Added timestamped changelog entry (`29/06/2026 – 00:17`) following Keep a Changelog format
  * Entry covers the update to CHANGELOG.md that documented the previous changelog automation chore
...
* Updated **CHANGELOG.md** to document the changelog finishing touch recipe execution:
  ...
  * Added timestamped changelog entry (`29/06/2026 – 00:16`) following Keep a Changelog format
  * Entry covers the update to CHANGELOG.md that documented the previous changelog automation chore
...
* Updated **CHANGELOG.md** to document the changelog finishing touch recipe execution:
  ...
  * Added timestamped changelog entry (`29/06/2026 – 00:15`) following Keep a Changelog format
  * Entry covers the update to CHANGELOG.md that documented the previous changelog automation chore
...
* Updated **CHANGELOG.md** to document the changelog finishing touch recipe execution:
  ...
  * Added timestamped changelog entry (`29/06/2026 – 00:14`) following Keep a Changelog format
  * Entry covers the update to CHANGELOG.md that documented the previous changelog automation chore
...
* Updated **CHANGELOG.md** to document the changelog finishing touch recipe execution:
  ...
  * Added timestamped changelog entry (`29/06/2026 – 00:13`) following Keep a Changelog format
  * Entry covers the update to CHANGELOG.md that documented the previous changelog automation chore
...
* Updated **CHANGELOG.md** to document the changelog finishing touch recipe execution:
  ...
  * Added timestamped changelog entry (`29/06/2026 – 00:12`) following Keep a Changelog format
  * Entry covers the update to CHANGELOG.md that documented the previous changelog automation chore
...
* Updated **CHANGELOG.md** to document the changelog finishing touch recipe execution:
  ...
  * Added timestamped changelog entry (`29/06/2026 – 00:11`) following Keep a Changelog format
  * Entry covers the update to CHANGELOG.md that documented the previous changelog automation chore
